// Command archive fetches one tournament's results from a Live! by BULA 3.0.6
...
import (
	...
	bula "github.com/cxd309/ultimate-tournament-results/internal/bula/v03_00_06"
...
func run() error {
	...
	schema, err := os.ReadFile("db/v03_00_06/schema.sql")
	if err != nil {
