...
import (
	...
	liveclient "github.com/cxd309/ultimate-tournament-results/internal/liveclient/v01_09_17"
	store "github.com/cxd309/ultimate-tournament-results/internal/store/v01_09_17"
)

// Archive fetches one tournament from a live 1.9.17 deployment and writes it
...
func Archive(ctx context.Context, host, basePath, slug, dbPath string) (livearchive.Summary, error) {
	return livearchive.Run(ctx, livearchive.Deps[*liveclient.Snapshot]{
		SchemaPath: "db/v01_09_17/schema.sql",
